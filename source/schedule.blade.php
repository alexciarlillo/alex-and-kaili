        ...
        <div class="container mx-auto">
            ...
            <div class="w-full px-6 text-center min-w-sm max-w-4xl mx-auto font-info text-4xl text-purple-900 leading-tight mt-12">
                ...
                <div class="mx-auto flex flex-col items-center">
                    <div class="flex-col md:flex flex-between justify-start pb-12 mt-6">
                        <span class="text-4xl md:mr-4 pb-6">5:00pm</span>
                        <p class="md:ml-4 text-3xl min-w-md">
                ...
                <div class="mx-auto flex flex-col items-center mt-12">
                    <div class="flex-col md:flex flex-between justify-start pb-12 mt-6">
                        <span class="text-4xl md:mr-4">5:30pm</span>
                        <p class="md:ml-4 text-3xl min-w-md">
                ...
                <div class="mx-auto flex flex-col items-center mt-12">
                    <div class="flex-col md:flex flex-between justify-start pb-12 mt-6">
                        <span class="text-4xl md:mr-4">6:30pm</span>
                        <p class="md:ml-4 text-3xl min-w-md">
